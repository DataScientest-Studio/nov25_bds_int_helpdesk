...
# ════════════════════════════════════════════════════════════════════════════
# People Overview – immer sichtbar als Seitenheader
# ════════════════════════════════════════════════════════════════════════════
...
# ════════════════════════════════════════════════════════════════════════════
# TABS (5 Tabs — ohne People Overview)
# ════════════════════════════════════════════════════════════════════════════
tab_perf, tab_tickets, tab_training, tab_trends, tab_risk = st.tabs([
    t("📊 Performance", "📊 Performance"),
    t("🎫 Ticket Details", "🎫 Ticket Details"),
    t("🏋️ Training & Deficits", "🏋️ Training & Deficits"),
    t("📈 Trend-Analyse", "📈 Trend Analysis"),
    t("⚠️ Risk Level Definition", "⚠️ Risk Level Definition"),
])


# ════════════════════════════════════════════════════════════════════════════
# Tab 2: Trend Analysis (C4)
# ════════════════════════════════════════════════════════════════════════════
with tab_trends:
    ...
    if not employee_df_c4.empty:
        ...
        fig = px.scatter(
            ...
            color_discrete_map={'GREEN': '#4CAF50', 'YELLOW': '#FF9800', 'RED': '#f44336'},
            labels={'Tickets': t('Ticket-Anzahl', 'Ticket Count'), 'Avg Score': t('Ø Score', 'Avg Score'), 'Risk Level': t('Risikostufe', 'Risk Level')}
        )
...
# ════════════════════════════════════════════════════════════════════════════
# Tab 4: Risk Level Definition (C6)
# ════════════════════════════════════════════════════════════════════════════
with tab_risk:
    section_header(e("📖 ") + get_text('risk_level_def'))
    st.markdown(get_text('interpretation') if st.session_state.get('language') == 'en' else
